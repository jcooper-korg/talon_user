...
alpha_alt = 'arch brov char dell etch fomp goof hark ice jinx koop lug mowsh nerb ork pooch quosh rosh sun teak unks verge womp trex yang zooch'.split()  # jsc using voicecode alphabet for now
...
ctx.keymap({
    '(uppercase | ship | sky | upper) {basic_keys.alphabet}+ [(lowercase | sunk)]': uppercase_letters,		# jsc added sky
